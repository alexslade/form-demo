...
/*!********************************************************************************!*\
  !*** /Users/alex/Work/SH24/phoenix_live_view/priv/static/phoenix_live_view.js ***!
  \********************************************************************************/
  ...
  return function (e) {
    ...
    var $ = function (e, t, n, i) {
      ...
      discardError: function (e, t, n) {
        var i = this,
            r = t.getAttribute && t.getAttribute(n),
            o = r && e.querySelectorAll("[name='".concat(r, "']"));

        if (console.log(r), o && 0 != o.length) {
          var a = x(o).some(function (e) {
            return i.private(e, "phx-has-focused");
          }),
              u = this.private(o[0].form, "phx-has-submitted");
          a || u || t.classList.add("phx-no-feedback");
        }
      },
...
/* harmony import */ var phoenix_live_view__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! phoenix_live_view */ "../../phoenix_live_view/priv/static/phoenix_live_view.js");
